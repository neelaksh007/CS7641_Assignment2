...
class QSARbiodegradation(DataLoader):
    def __init__(self, path='data/biodeg.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def _preprocess_data(self):
        ...
        print ("YAA")
        print (self._data)
        self._data[41] = le.fit_transform(self._data[41].values)
