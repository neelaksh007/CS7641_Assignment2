...
def main():
    """Run this experiment"""
    with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_NN_RHC_Starting_AT", 'w') as f:
    ...
    with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_NN_RHC_ending_AT", 'w') as f:
        f.write('{}'.format(datetime.datetime.now()))
