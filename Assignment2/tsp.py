...
with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_TSP_STARTING_AT", 'w') as f:
...
with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_TSP_ENDING_AT", 'w') as f:
        f.write('{}'.format(datetime.datetime.now()))
