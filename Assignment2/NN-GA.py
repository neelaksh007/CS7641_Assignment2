...
if __name__ == "__main__":
    with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_NN_GA_Starting_AT", 'w') as f:
    ...
    for p in [50]:
        for mate in [20, 10]:
            for mutate in [20, 10]:
                args = (p, mate, mutate)
                main(*args)
    with open("/home/ec2-user/CS-7641-assignments/my_assignment2/I_am_NN_GA_Ending_AT", 'w') as f:
        f.write('{}'.format(datetime.datetime.now()))            
